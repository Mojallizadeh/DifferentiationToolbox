...
function [u,calculation_time] = E_HDD(f_k,h,L,reset_flag,order,x0)
...
persistent z0 z1 z2 z3 CT
    ...
    z10=h*(-lambda1*L^(2/4)*abs(z0-f_k)^(2/4)*sign(z0-f_k)+z2)+z1      +h^2*z3/2   ; 
    z20=h*(-lambda2*L^(3/4)*abs(z0-f_k)^(1/4)*sign(z0-f_k)+z3)+z2         ; 
